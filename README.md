...
## Goals
Creating applications for the web is a vast landscape. Entire businesses have come and gone teaching only fractions of it. The goal of this course was to provide a thorough tour, focusing mainly on core technologies. No transpiling, minimal if any bundling, and no front-end frameworks (like React, Vue, Angular, etc.). 

The intention is to equip you with enough knowledge to turn your ideas into homegrown services for specific, small-scope needs. Need to track how many glasses of water you drank today? Easy—you can build it quickly and make it work just for you.
